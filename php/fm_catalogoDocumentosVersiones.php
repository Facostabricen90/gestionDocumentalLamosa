        ...
        <div class="panel-heading">
          ...
          <div class="row">
            <div class="col-lg-2 col-md-2">
                <strong class="letra16">Catálogo Documentos (Versiones)</strong>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-3">
              <br>
              <div class="input-group"> <span class="input-group-addon"><strong>Buscar:</strong></span>
                <input id="filtrar_CatalogoVersiones" type="text" class="form-control">
              </div>
            </div>
            <?php if($resUsuA){ ?>
						<?php if($cantAreas >= 2){ ?>
							<div class="form-group col-lg-2 col-md-2 col-sm-2">
								...
								<select id="Cat_Area_CodigoVersiones" class="form-control" required>
						...
						<?php }else{ ?>
							<?php foreach($resUsuA as $registro){ ?>
								<input type="hidden" id="Cat_Area_CodigoVersiones" class="form-control" value="<?php echo $registro[0]; ?>">
							<?php } ?>
						<?php } ?>
					<?php } ?>
          ...
          <div class="form-group col-lg-2 col-md-2 col-sm-2">
            ...
            <select id="Cat_TipoDocumentoVersiones" class="form-control" required>
              <option value="-1">Todos</option>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
              <div class="form-group">
                ...
                <select id="FiltroCatDocVer_Pais" class="form-control" multiple data-mod="FiltroCatDocVer_Planta">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 e_cargarFiltroCatDocVerPlantas">
              <div class="form-group">
                <label class="control-label">Planta:</label>
                <select id="FiltroCatDocVer_Planta" class="form-control">
                </select>
              </div>
            </div>
            ...
            <div class="col-lg-1 col-md-1 col-sm-1">
              <br>
                <button id="Btn_CatDocVersBuscar" class="btn btn-primary">Buscar</button>
            </div>
            
            <div class="col-lg-1 col-md-1 col-sm-1">
              <br>
              <form action="op_excelExportacion.php" method="post" id="f_exportarCatalogoVer" target="_blank">
                <img src="../imagenes/excel.png" width="30" height="30" id="btn_excelCatalogoVer" class="manito">
                <input type="hidden" name="nombre" value="Catálogo Documentos (Versiones)">
                <input type="hidden" name="resultado" id="input_resultadoCatalogoVer">
              </form>
            </div>
            <div class="col-lg-1 col-md-1 col-sm-1">
              <br>
              <a href="fm_catalogoDocumentos.php"><button class="btn btn-info">Volver</button></a>
            </div>
          </div>
        </div>
        <div class="panel-body info_catalogoDocumentosVersionesListar">
