...
$sol = new solicitudes();
$resSol = $sol->listarSolicitudesFiltroPublicado($_POST['area'], $_POST['tipo'], $_SESSION['GD_Usuario'], $_POST['planta']);
$resSolVer = $sol->listarSolicitudesFiltroPublicadoUltimaVersion($_POST['area'], $_POST['tipo'], $_SESSION['GD_Usuario'], $_POST['planta']);
...
<?php if ($cantAreas > 0){ ?>
  <div class="table-responsive">
    <table id="tbl_catalogoDocumentosVersiones" border="1px" class="table tableEstrecha table-hover table-bordered table-striped">
      <thead>
  ...
  <div class="table-responsive" style="display: none;">
    <table id="tbl_catalogoDocumentosExpVer" border="1px" class="table tableEstrecha table-hover table-bordered table-striped">
      <thead>
        <tr class="ordenamiento encabezadoTab">
          <th>CÓDIGO</th>
          <th>FECHA SOLICITUD</th>
