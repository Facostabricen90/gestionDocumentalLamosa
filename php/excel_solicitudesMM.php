...
header("Content-Disposition: attachment; filename=SolicitudesMatriz.xls");
...
$sol = new solicitudes();
$resSol = $sol->listarSolicitudesMMPrinpal($_GET['fechaInicial'], $_GET['fechaFinal'], $_GET['estado'], $_GET['area']);
