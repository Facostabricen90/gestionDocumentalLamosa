...
$sol = new solicitudes();
$resSol = $sol->listarSolicitudesMMPrinpal($_POST['fechaInicial'], $_POST['fechaFinal'], $_POST['estado'], $_POST['area'], $_SESSION['GD_Usuario'], $_POST['planta']);

$fluA = new flujos_aprobaciones();
$resFluA = $fluA->listarFlujoAprobacionesSolicitudesUsuariosTipoFlujoMM($_SESSION['GD_Usuario']);
...
$par = new parametros();
$resParPas = $par->listarParametroTipo("3");
...
<div class="table-responsive">
    <table id="tbl_SolicitudesMM" border="1px" class="table tableEstrecha table-hover table-bordered table-striped letra11">
        <thead>
            ...
            <?php if ($usu->getUsu_Rol() == "Administrador") { ?>
                ...
                foreach ($resSol as $registro) {
                    ...
                    if ($registro[10] != "Publicado") {
                        ...
                        //var_dump($registro['Sol_NombreDocumento']);
                        ?>
                        <tr data-fecmax="<?php echo $fechaMax; ?>">
                            ...
                            <td class="vertical" align="center"><button class="btn btn-warning btn-xs e_cargarSolicitudMMGestion" data-cod="<?php echo $registro[0]; ?>">Gestionar</button></td>
                            <?php if ($usu->getUsu_Rol() == "Administrador") { ?>
                                <td class="vertical" align="center"><button class="btn btn-info btn-xs e_cargarSolicitudGestionAdminMMAct" data-cod="<?php echo $registro[0]; ?>">Adm</button></td>  
                            <?php } ?>
                        </tr>
                        <?php
                        $cont++;
                    ...
                    <?php if (isset($Areas[$registro[13]])) { ?>	
                        ...
                        if ($registro[10] != "Publicado") {
                            ...
                            <tr>
                                ...
                                <?php if (isset($Paso[$registro[13] . $registro[14] . $registro[17]])) { ?>
                                    <td class="vertical" align="center"><button class="btn btn-warning btn-xs e_cargarSolicitudMMGestion" data-cod="<?php echo $registro[0]; ?>">Gestionar</button></td>
                                <?php } else { ?>
                                    <td class="vertical" align="center"><button class="btn btn-info btn-xs e_cargarSolicitudMMVerHistorial" data-cod="<?php echo $registro[0]; ?>">Consultar</button></td>
                            <?php } ?>
                            </tr>
                            <?php $cont++;
                        }
...
<div class="table-responsive" style="display: none">
    <table id="tbl_Cicloexpmm" border="1px" class="table tableEstrecha table-hover table-bordered table-striped letra11">
        <thead>
            <tr class="ordenamiento encabezadoTab">
                <th class="text-center" align="center">CÓD</th>
                <th class="text-center" align="center">FECHA<br>SOLICITUD</th>
